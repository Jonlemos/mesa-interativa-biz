...
export default function Home() {
  ...
  useEffect(() => {
    ...
    lat2 && console.log(lat2);
    long2 && console.log(long2);
            ...
            <div className={styles.figures}>
              <div className={styles.grid_left}>
                <svg width="130" height="130" viewBox="0 0 130 130" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M40.8468 23.8446L23.8446 40.8468L47.6892 64.6914L23.8446 88.536L40.8468 105.538L64.6914 81.6936L88.5359 105.538L105.538 88.536L81.6936 64.6914L105.538 40.8469L88.5359 23.8446L64.6914 47.6892L40.8468 23.8446Z" fill="#C4C4C4"/>
                  </mask> <g mask="url(#mask0)"> <circle cx="64.3987" cy="65.571" r="34.9807" stroke="#FFF8F3"/>
                  </g>
                </svg>
              </div>
